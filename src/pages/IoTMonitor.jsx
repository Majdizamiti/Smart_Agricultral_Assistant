...
function IoTMonitor() {
    ...
    useEffect(() => {
        ...
        const unsubscribe = onValue(dbRef, (snapshot) => {
            if (snapshot.exists()) {
                ...
                // Extract sensor values directly from firebase/iot/data
                const {
                    humidity,
                    temperature,
                    light,
                    ...
                    waterlevel,
                    van,
                    autoSettings: autoSettingsData
                } = data;

                // Set sensor data directly from root level
                setSensorData({
                    humidity: humidity || 0,
                ...
                // Set auto settings (kept alongside sensor data)
                setAutoSettings(autoSettingsData || {});
            }
        });
    ...
    const getSensorDisplay = (sensorType, value) => {
        const shared = sensorFactory.getShared(sensorTypes[sensorType]);
